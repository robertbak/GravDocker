#!/bin/sh
declare -a versions=("1.6.26" "1.6.23" "1.6.19" "1.6.16" "1.6.9" "1.6.8" "1.6.7" "1.6.5" "1.5.8" "1.5.6" "1.5.5" "1.5.2" "1.5.1" "1.4.8" "1.4.5" "1.4.3" "1.4.2" "1.4.1" "1.3.10" "1.3.8" "1.3.6" "1.3.5" "1.3.4" "1.3.3" "1.3.1" "1.3.0" "1.2.4" "1.2.3" "1.2.0" "1.1.17" "1.1.16" "1.1.15" "1.1.14")
latest=${versions[0]}
